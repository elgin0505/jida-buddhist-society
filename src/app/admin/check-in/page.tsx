...
export default function AdminCheckInPage() {
  ...
  const handleCheckIn = async () => {
    ...
    const points =
      customPoints !== "" ? Number(customPoints) : (event?.points ?? 1);
    ...
    try {
      ...
      if (!res.ok) {
        ...
        setMessage({
          type: "success",
          text: `${scannedMember.name} 签到成功！获得 ${points} 积分`,
        });
        ...
        <Card>
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className="btn-jade w-full py-3"
            >
