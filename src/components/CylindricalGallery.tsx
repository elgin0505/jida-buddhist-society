...
export const BUDDHISM_CONFIG: ActivityGalleryConfig = {
  ...
  photos: [
    {
      id: 1,
      src: '/gallery/buddhism/dharma_1.jpg',
      alt: '静心抄经 · 般若波罗蜜多心经',
    },
    {
      id: 2,
      src: '/gallery/buddhism/dharma_2.jpg',
      alt: '佛法史传 · 大乘佛教的形成',
    },
    {
      id: 3,
      src: '/gallery/buddhism/dharma_3.jpg',
      alt: '善巧研习 · 性格与心灵沟通',
    },
    {
      id: 4,
      src: '/gallery/buddhism/dharma_4.jpg',
      alt: '法师慈悲开示 · 人生三大追求',
    },
    {
      id: 5,
      src: '/gallery/buddhism/dharma_5.jpg',
      alt: '因缘果报 · 改变由我开始',
    },
    {
      id: 6,
      src: '/gallery/buddhism/dharma_6.jpg',
      alt: '生死无常 · 向死而生的智慧',
    },
  ],
};
...
export const LIFE_CONFIG: ActivityGalleryConfig = {
  ...
  badge: '青年觉察 · 时间轮盘',
  description: '以佛法智慧觉察日常作息，拨动专属时间轮盘 · 在青春同行中安顿身心',
  centerTitle: '生活课题班例常',
  ...
  photos: [
    {
      id: 7,
      src: '/images/life/life-1.jpg',
      alt: '手绘时间轮盘 · 觉察当下作息',
    },
    {
      id: 8,
      src: '/images/life/life-2.jpg',
      alt: '课题研讨交流 · 专注聆听思惟',
    },
    {
      id: 9,
      src: '/images/life/life-3.jpg',
      alt: '吉祥祈愿豆 · 传递温情祝福',
    },
    {
      id: 10,
      src: '/images/life/life-4.jpg',
      alt: '同修诞辰庆生 · 共享法喜甜蜜',
    },
    {
      id: 11,
      src: '/images/life/life-5.jpg',
      alt: '结缘红包留念 · 彼此感恩赋能',
    },
    {
      id: 12,
      src: '/images/life/life-6.jpg',
      alt: '全体同修合影 · 欢喜圆满留念',
    },
  ],
};
